...
pub use command::{
    ...
    HelloFeature, ObserveSeqNoResponse, StreamFilter, StreamRequest, StreamRequestResponse,
    VBucketSeqNo, VBucketState, buffer_ack, close_stream, dcp_control, dcp_open, delete_document,
