...
pub use rust_dcp_core::{
    ...
    CollectionSelection, CollectionStream, CouchbaseCheckpointCollection, CouchbaseCheckpointStore,
    ...
    RollbackHandler, RollbackPolicy, RollbackRequest, SeedAddress, SeqNoAdvanced, SnapshotFlags,
    SnapshotMarker, StartPosition, StreamEnd, StreamEndReason, StreamFilter, StreamOpenReport,
    SystemEvent, SystemEventKind, TlsConfig, TopologyNetwork, TrackedEvent, VBucketAssignment,
